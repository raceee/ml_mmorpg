...
class Boss:
    def __init__(self, bs_name, bs_health, bs_atk1dmg, bs_atk1miss, bs_atk2dmg, bs_atk2miss):
        self.bs_name = bs_name
        self.bs_health = bs_health
        self.bs_atk1dmg = bs_atk1dmg
        self.bs_atk1miss = bs_atk1miss
        self.bs_atk2dmg = bs_atk2dmg
        self.bs_atk2miss = bs_atk2miss

    def get_bs_health(self):
        return self.bs_health

    def bs_loose_health(self, damage):
        self.bs_health -= damage

    def bs_get_name(self):
        return self.bs_name

    def bs_get_atk1_dmg(self):
        return self.bs_atk1dmg

    def bs_get_atk1_miss(self):
        return self.bs_atk1miss

    def bs_get_atk2_dmg(self):
        return self.bs_atk2dmg

    def bs_get_atk2_miss(self):
        return self.bs_atk2miss

class player_constructor:
    def __init__(self, pl_name, pl_health, pl_atk1dmg, pl_atk1miss, pl_atk2dmg, pl_atk2miss, pl_dodge, pl_atk1_name,
                 pl_atk2_name):
        self.pl_name = pl_name
        self.pl_health = pl_health
        self.pl_atk1dmg = pl_atk1dmg
        self.pl_atk1miss = pl_atk1miss
        self.pl_atk2dmg = pl_atk2dmg
        self.pl_atk2miss = pl_atk2miss
        self.pl_dodge = pl_dodge
        self.pl_atk1_name = pl_atk1_name
        self.pl_atk2_name = pl_atk2_name
